...
export default function ProjectPage() {
  ...
  return (
    <main className="min-h-screen w-full min-w-80 p-2 pt-16 pb-8 flex flex-col gap-4 md:w-200 overflow-x-hidden mx-auto">
      {/* back button */}
      <button
        onClick={handleBack}
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* images */}
        <div className="h-80 border rounded-md"></div>
